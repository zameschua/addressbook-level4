...
=== Search people by name / address / tags / email / phone: `find`
...
Returns any person whose address contains `serangoon` and whose phone number is `99876261`
...
Format: `mass all` or `mass KEYWORD` +
