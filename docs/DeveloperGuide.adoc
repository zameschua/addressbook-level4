...
The *_Architecture Diagram_* given below (_Figure 2.1.1_) explains the high-level design of the App. Read on for a quick overview of each component.
...
For example, the `Logic` component (see the class diagram given below, _Figure 2.1.2_) defines its API in the `Logic.java` interface and exposes its functionality using the `LogicManager.java` class.
