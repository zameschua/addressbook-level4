...
*Code contributed*: [https://github.com/CS2103AUG2017-W15-B2/main/blob/master/collated/main/ReneeSeet.md[Functional code]] [https://github.com/CS2103AUG2017-W15-B2/main/blob/master/collated/test/ReneeSeet.md[Test code]] {give links to collated code files}
